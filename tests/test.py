...
def main():
    ...
    model.thermal_field_transformation(Temp=1000)
    model.reduce_H_tilde()
    model.sum_over_states(basis_size=20, output_path=outputdir, T_initial=1000, T_final=100, N=10000)
    model.TFCC_integration(T_initial=1e3, T_final=100, N=10000, output_path=outputdir)
