...
def main():
    ...
    model.thermal_field_transformation(Temp=4e2)
    model.reduce_H_tilde()
    model.sum_over_states(basis_size=40, output_path=outputdir, T_initial=1e3, T_final=1e2, N=10000)
    model.TFCC_integration(T_initial=1e3, T_final=1e2, N=100000, output_path=outputdir)
