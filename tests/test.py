...
def main():
    ...
    model.TFCC_integration(T_initial=1e5, T_final=100, N=100000, output_path=outputdir)
    model.sum_over_states(basis_size=80, output_path=outputdir, T_initial=10000, T_final=100, N=10000, compare_with_TNOE=True)
